...
I'm a visual learner so being able to see a variety of arcs and having them for reference in the future sounded helpful. The arc reference page covers everything but after reading it I still wasn't 100% on how these things work. Making this poster helped a little.
...
function keyPressed() {
  if (keyCode === RETURN) {
    saveCanvas('FIGURING OUT ARCS', 'jpg');
  }
}
